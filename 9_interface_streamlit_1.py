...
#on dézippe le fichier csv (car trop lourd pour être chargé tel quel sur GitHub)
with zipfile.ZipFile("export_simplifie6.zip", 'r') as zip_ref:
    zip_ref.extractall("export_simplifie6.csv")
